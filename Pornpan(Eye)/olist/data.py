...
class Olist:
    def get_data(self):
        ...
        """
        # 1: Build csv_path as "absolute path" in order to call this method from anywhere.
        ...
        # 2: Use os.path library to construct path independent of Mac vs. Unix vs. Windows specificities
