...
class Order:
    ...
    def get_training_data(self,
        ...
        #           len(self.get_number_products(),\
        #               len(self.get_number_sellers(),\
        #                   len(self.get_price_and_freight()) )
        # return None
        # dfs = [self.get_wait_time(),self.get_review_score(),self.get_number_products(),self.get_number_sellers(),self.get_price_and_freight()]
        # #merge all DataFrames into one
        # training_set= reduce(lambda  left,right: pd.merge(left,right,on=['order_id'],
        #                                     how='inner'), dfs)
